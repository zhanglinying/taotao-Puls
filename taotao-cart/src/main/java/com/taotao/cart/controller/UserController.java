...
import com.taotao.cart.service.ApiService;
import com.taotao.cart.service.JedisClient;
...
public class UserController {
    ...
    private static final String key = "http://sso.taotao.com";
    ...
    public Map toUser(@PathVariable(value = "token") String token) throws IOException {
        ...
        try {
            String json = this.apiService.doGet(key + "/service/user/" + token);
