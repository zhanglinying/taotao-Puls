...
var category = {
    ...
    FN_RefactorJSON: function (a, b) {
        ...
        for (var f = 0, g = 0; g < a.length; g++) g % b == 0 && f++, d[f - 1].tabs.push(a[g]), d[f - 1].increment = f, d[f - 1].skuids.push(a[g].wid);
        return d
    },
...
var $o = function () {
    ...
    var c = '<a style="color:#005AA0" onclick="$o.del(event)">\u5220\u9664</a>', d = "\u641c\u7d22\u5386\u53f2",
        ...
        i = "http://dd.search.jd.com/?key=#{keyword}", j = "#FFDFC6", k = "#FFF", l = $("#key"), m = $("#shelper");
