...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">您好！欢迎来到淘淘！<a href="http://sso.taotao.com/login.html">[登录]</a>&nbsp;<a href="http://sso.taotao.com/register.html">[免费注册]</a></li>
			...
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d">
				...
				<a href="http://app.jd.com/" target="_blan最近更新最近更新最近更新最近更新最近更新最近更新最近更新最近更新k">手机淘淘</a><b></b>
			</li>
