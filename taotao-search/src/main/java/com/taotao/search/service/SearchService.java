...
public class SearchService {
    ...
    public SearchResult search(String keyWord, Integer page) throws SolrServerException {
        SolrQuery solrQuery = new SolrQuery();    //构造搜索条件
        solrQuery.setQuery("title:" + keyWord + "AND status:1"); //搜索关键字
        //设置分页start=0就是从0开始，rows=5条记录
